...
- **Config paths**:
  - Use absolute prod path for home 
    ...
    - https://github.com/AdobeDocs/express-add-ons-docs/blob/eds-migration/src/pages/config.md?plain=1#L5
  - Relative paths should be relative to path prefix and not start with "/"
    - e.g.  `[Add-on UI SDK](references/addonsdk/)`
    - https://github.com/AdobeDocs/express-add-ons-docs/blob/eds-migration/src/pages/config.md?plain=1#L14
  ...
  - On any parent section page (like /guides/, /community/, etc.), the sidebar navigation automatically displays all the child pages within that section. For example, in the config.md, if there is any subpages (eg. /guides/code-contribution) which is within the same parent section, the sidenav will show up.  This contextual sidebar appears for any page that has sub-pages, helping users easily navigate through related content without having to go back to higher-level pages.
    ...
    - config: https://github.com/AdobeDocs/adobe-dev-console/blob/eds-migration/src/pages/config.md
...
- **Fragments**:
  - Instead of import: https://github.com/AdobeDocs/app-builder/blob/main/src/pages/resources/ci-cd/requirements.md?plain=1#L10-L12 use fragment: https://github.com/AdobeDocs/adp-devsite-github-actions-test/blob/main/src/pages/fragment.md?plain=1#L5
