...
- subPages:
    ...
    - [Blocks](/blocks/index.md)
      - [Configuration Blocks](#configuration-blocks)
        ...
        - [Credential](/blocks/credential/index.md)
      ...
      - [Content Blocks](#content-blocks)
        ...
        - [InfoCard](/blocks/infocard/index.md)
            ...
            - [InfoCard with video](/blocks/infocard/infocard-with-video.md)
        ...
        - [Superhero](/blocks/superhero/index.md)
            - [Superhero Default](blocks/superhero/default/index.md)
                ...
                - [Superhero Default with Text and Background Color](blocks/superhero/default/with-text-and-background-color.md)
            ...
            - [Superhero Centered](blocks/superhero/centered/index.md)
                ...
                - [Superhero Centered with Text and Background Color](blocks/superhero/centered/with-text-and-background-color.md)
            - [Superhero Centered XL](blocks/superhero/centeredxl/index.md)
                ...
                - [Superhero Centered XL with Text and Background Color](blocks/superhero/centeredxl/with-text-and-background-color.md)
            - [Superhero Half Width](blocks/superhero/halfwidth/index.md)
                ...
                - [Superhero Half Width with Text and Background Color](blocks/superhero/halfwidth/with-text-and-background-color.md)
