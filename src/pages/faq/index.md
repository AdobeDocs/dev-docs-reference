...
After the redirects expire, the new pages can still be found via search and re-bookmarked. Note that the EDS platform handles the trailing slash (`/`) differently from Gatsby — see [Paths and Links](../../getting-started/dev-docs/best-practices/#paths-and-links).
